...
exports.Generator = exports.Element = void 0;
...
class Element {
    ...
    setParams(inName, outName, signals) {
        for (let i = 0; i < outName.length; i++) {
            this.out_connections.push(factories_1.Factories.Connection.create({ name: outName[i], element: this }));
        }
...
class Generator {
    ...
    constructor(arg1, frequency) {
        if (typeof arg1 === 'string' && frequency) {
            ...
            this.out_connections = [factories_1.Factories.Connection.create({ name: arg1, element: this })];
        }
        else {
            this.frequency = arg1;
            this.out_connections = [factories_1.Factories.Connection.create({ name: '', element: this })];
        }
    }
    /**
